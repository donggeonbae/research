...
**pipe 0.921 / jet 0.928 / wake 0.212** (mean-of-3 0.687). 밤사이 시작점 0.86/0.77/0.06 대비 대폭 상승, 전부 event-only·단일 config·정직(그림 검증).

남은 것은 상류 **velocity 추정기(front-end)** 영역(wake 응력 진폭 ~0.5×, 역류 자성) — deposit/누적/정규화 노브로는 닿지 않음. 다음 자율 탐색 대상.
